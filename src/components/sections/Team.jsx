...
const Team = () => {
  ...
  return (
    <>
      ...
      {/* Campus Ambassadors Gallery Section */}
      <section id="campus-ambassadors" className="py-20 bg-neutral-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            {[
              ...
              <motion.div
                ...
                onClick={() => setSelectedAmbassador(filename)}
              >
                <motion.img
                  src={`/images/CA_Team/${filename}`}
                  alt={`Campus Ambassador ${index + 1}`}
            ...
            {selectedAmbassador && (
              ...
              >
                ...
                >
                  ...
                  <motion.img
                    src={`/images/CA_Team/${selectedAmbassador}`}
                    alt="Campus Ambassador Preview"
